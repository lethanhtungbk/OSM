...
(1, 3, 'Country', 'sa_country'),
(2, 3, 'State', 'sa_state'),
(3, 1, 'Rank', 'sa_rank'),
(4, 3, 'Collage Type', 'sa_collage_type'),
(5, 3, 'Programe Type', 'sa_program_type'),
(6, 3, 'Discipline', 'sa_discipline'),
(7, 3, 'Size', 'sa_size'),
(8, 3, 'Collage House Type', 'sa_collage_house_type');
